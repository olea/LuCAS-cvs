...
%description -l es
La imprenta-e es una herramienta para facilitar la creación y
el mantenimiento de los formatos de publicación de documentos.
...
- Modificación del spec original de Gaspar para RH.
