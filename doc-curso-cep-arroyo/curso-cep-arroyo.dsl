...
;; ------------------------------------------------------------------------
;; $Id: curso-cep-arroyo.dsl,v 1.1 2003/06/09 19:48:19 juanfernandez Exp $
;; Copyright (C) 2000-2003
;; Modificaciones locales de ldp.dsl - LDP Customized DSSSL Stylesheet
;;
...
(define tex-backend
  ;; Dávila, 1 mayo 2003
  ;; Necesario para generar las notas a pie de página
...
(define (book-titlepage-verso-elements)
  ;;added publisher, releaseinfo to the default list
  ;;añado mediaobject
  ;; quito revhistory, porque se compone fatal y no cabe en la página
  (list (normalize "title")
        (normalize "subtitle")
        (normalize "corpauthor")
        (normalize "authorgroup")
