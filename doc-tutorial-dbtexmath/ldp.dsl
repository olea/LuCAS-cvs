...
;; ------------------------------------------------------------------------
;; Customization of ldp.dsl so that it works in the case of DBTexMath
;; Jaime Davila April 20-2004. Released under GPL

<style-specification id="print" use="docbook">
<style-specification-body> 

;; Additions to the print part of the ldp.dsl
...
;;Additions to the html part of ldp.dsl
&htmlmath.dsl;
